...
<body>
    ...
    <div style="text-align: center;">
      ...
      <br>
        ...
        <p style="text-align: justify;"> Yang terhormat Bapak/Ibu {{$emailDataLogin['nama']}}, <br><br>Terima kasih telah menjadi customer kami, silahkan login pada link http://bit-timeline.epizy.com atau download aplikasi android pada link https://s.id/download-bit-timeline-apk untuk bertransaksi, <br><br><br>
