...
<body>
    ...
    <div style="text-align: center;">
      ...
      <br>
        ...
        <p style="text-align: justify;"> Yang terhormat Kakak {{$emailDataLogin['nama']}}, <br><br>Silahkan login pada link http://bit-timeline.epizy.com atau download aplikasi android pada link shttps://s.id/download-bit-timeline-apk untuk memantau dan update progres pengerjaan aplikasi anda, <br><br><br>
